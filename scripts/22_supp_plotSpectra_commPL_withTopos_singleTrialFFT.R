...
# --- content: plotting spectra for different conditions (common pipeline, single-trial FFT, spectral amplitude)
...
savename = paste0(parentFolder,"/figures/22_supp_spectra_commPL_singleTrialFFT.pdf")
ggsave(filename = savename, plot = specPlots, device = "pdf",
       width = 21, height = 15, unit = "cm", limitsize = FALSE)

savename = paste0(parentFolder,"/figures/22_supp_spectra_commPL_singleTrialFFT.jpg")
