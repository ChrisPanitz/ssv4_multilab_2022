...
# --- content: plotting topographies for different conditions and labs (common pipeline, single-trial FFT)
...
# save plots
savename = paste0(parentFolder,"/figures/27_supp_topos_commPL_singleTrialFFT_Florida.pdf")
ggsave(filename = savename, plot = toposFL, device = "pdf",
       width = 21, height = 15, unit = "cm", limitsize = FALSE)

savename = paste0(parentFolder,"/figures/27_supp_topos_commPL_singleTrialFFT_Florida.jpg")
ggsave(filename = savename, plot = toposFL, device = "jpg",
       width = 21, height = 15, unit = "cm", limitsize = FALSE)

savename = paste0(parentFolder,"/figures/27_supp_topos_commPL_singleTrialFFT_Leipzig.pdf")
ggsave(filename = savename, plot = toposLE, device = "pdf",
       width = 21, height = 15, unit = "cm", dpi = 300, limitsize = FALSE)

savename = paste0(parentFolder,"/figures/27_supp_topos_commPL_singleTrialFFT_Leipzig.jpg")
