...
# --- content: plotting SNR topographies for different conditions and labs (common pipeline)
...
# save plots
savename = paste0(parentFolder,"/figures/17b_topos_commPL_Florida_SNR.pdf")
ggsave(filename = savename, plot = toposFL, device = "pdf",
       width = 21, height = 15, unit = "cm", limitsize = FALSE)

savename = paste0(parentFolder,"/figures/17b_topos_commPL_Florida_SNR.jpg")
ggsave(filename = savename, plot = toposFL, device = "jpg",
       width = 21, height = 15, unit = "cm", limitsize = FALSE)

savename = paste0(parentFolder,"/figures/17b_topos_commPL_Leipzig_SNR.pdf")
ggsave(filename = savename, plot = toposLE, device = "pdf",
       width = 21, height = 15, unit = "cm", dpi = 300, limitsize = FALSE)

savename = paste0(parentFolder,"/figures/17b_topos_commPL_Leipzig_SNR.jpg")
