...
# --- content: plotting spectra and topographies for different conditions (common pipeline, SNR topographies)
...
# spectra & topographies
savename = paste0(parentFolder,"/figures/12b_spectra_commPL_SNRtopos.pdf")
ggsave(filename = savename, plot = specPlots, device = "pdf",
       width = 21, height = 15, unit = "cm", limitsize = FALSE)

savename = paste0(parentFolder,"/figures/12b_spectra_commPL_SNRtopos.jpg")
ggsave(filename = savename, plot = specPlots, device = "jpg",
       width = 21, height = 15, unit = "cm", dpi = 300, limitsize = FALSE)

# topographies only
savename = paste0(parentFolder,"/figures/12b_onlySNRtopos_commPL.pdf")
ggsave(filename = savename, plot = topoPlots, device = "pdf",
       width = 21, height = 15, unit = "cm", limitsize = FALSE)

savename = paste0(parentFolder,"/figures/12b_onlySNRtopos_commPL.jpg")
