...
for (i in 1:length(list6box)) {
  ...
  if (substr(list6box[i],1,2) == "FL") {
    ...
    if (exists("topoMatFL6box")) {
      #topoMatFL6box <- cbind(topoMatFL6box, rowMeans(currData[,FLbin6]))
      topoMatFL6box <- cbind(topoMatFL6box, currData[,FLbin6])
    } else {
      #topoMatFL6box <- rowMeans(currData[,FLbin6])
      topoMatFL6box <- currData[,FLbin6]
    }
    ...
    if (exists("topoMatLE6box")) {
      topoMatLE6box <- cbind(topoMatLE6box, rowMeans(currData[,LEbin6]))
    } else {
      topoMatLE6box <- rowMeans(currData[,LEbin6])
    }
  }
}
...
for (i in 1:length(list6sin)) {
  ...
  if (substr(list6sin[i],1,2) == "FL") {
    ...
    if (exists("topoMatFL6sin")) {
      #topoMatFL6sin <- cbind(topoMatFL6sin, rowMeans(currData[,FLbin6]))
      topoMatFL6sin <- cbind(topoMatFL6sin, currData[,FLbin6])
    } else {
      #topoMatFL6sin <- rowMeans(currData[,FLbin6])
...
for (i in 1:length(list857box)) {
  ...
  if (substr(list857box[i],1,2) == "FL") {
    ...
    if (exists("topoMatFL857box")) {
      #topoMatFL857box <- cbind(topoMatFL857box, rowMeans(currData[,FLbin857]))
      topoMatFL857box <- cbind(topoMatFL857box, currData[,FLbin857])
    } else {
      #topoMatFL857box <- rowMeans(currData[,FLbin857])
      topoMatFL857box <- currData[,FLbin857]
    }
    ...
    if (exists("topoMatLE857box")) {
      topoMatLE857box <- cbind(topoMatLE857box, rowMeans(currData[,LEbin857]))
    } else {
      topoMatLE857box <- rowMeans(currData[,LEbin857])
    }
  }
}
...
for (i in 1:length(list857sin)) {
  ...
  if (substr(list857sin[i],1,2) == "FL") {
    ...
    if (exists("topoMatFL857sin")) {
      #topoMatFL857sin <- cbind(topoMatFL857sin, rowMeans(currData[,FLbin857]))
      topoMatFL857sin <- cbind(topoMatFL857sin, currData[,FLbin857])
    } else {
      #topoMatFL857sin <- rowMeans(currData[,FLbin857])
...
for (i in 1:length(list15box)) {
  ...
  if (substr(list15box[i],1,2) == "FL") {
    ...
    if (exists("topoMatFL15box")) {
      #topoMatFL15box <- cbind(topoMatFL15box, rowMeans(currData[,FLbin15]))
      topoMatFL15box <- cbind(topoMatFL15box, currData[,FLbin15])
    } else {
      #topoMatFL15box <- rowMeans(currData[,FLbin15])
      topoMatFL15box <- currData[,FLbin15]
    }
    ...
    if (exists("topoMatLE15box")) {
      topoMatLE15box <- cbind(topoMatLE15box, rowMeans(currData[,LEbin15]))
    } else {
      topoMatLE15box <- rowMeans(currData[,LEbin15])
    }
  }
}
