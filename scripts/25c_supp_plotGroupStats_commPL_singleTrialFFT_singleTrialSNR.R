...
# --- content: plotting group stats for different conditions and labs (common pipeline, single-trial FFT, single-trial SNR)
...
savename = paste0(parentFolder,"/figures/23c_supp_means_commPL_singleTrialFFT_singleTrialSNR.pdf")
ggsave(filename = savename, plot = meanPlots, device = "pdf",
       width = 21, height = 15, unit = "cm", limitsize = FALSE)

savename = paste0(parentFolder,"/figures/23c_supp_means_commPL_singleTrialFFT_singleTrialSNR.jpg")
