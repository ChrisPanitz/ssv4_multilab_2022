...
# --- content: pairwise tests for ssVEP SNR data (from common pipeline)
...
t_test(group_by(df, freq), ssvepSNR_Z ~ mod, paired = TRUE, p.adjust.method = "none")
cohens_d(group_by(df, freq), ssvepSNR_Z ~ mod, paired = TRUE)
...
# Mod effects for different frequencies (simple effects)
t_test(group_by(df[df$lab == "Florida",], freq), ssvepSNR_Z ~ mod, paired = TRUE, p.adjust.method = "none")
cohens_d(group_by(df[df$lab == "Florida",], freq), ssvepSNR_Z ~ mod, paired = TRUE)
...
# Mod effects for different frequencies (simple effects)
t_test(group_by(df[df$lab == "Leipzig",], freq), ssvepSNR_Z ~ mod, paired = TRUE, p.adjust.method = "none")
cohens_d(group_by(df[df$lab == "Leipzig",], freq), ssvepSNR_Z ~ mod, paired = TRUE)
